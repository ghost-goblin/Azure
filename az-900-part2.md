...
- **IaC** - Ifrastucture as Code
  ...
  - **Azure RBAC** - apply access control to all services
  - Apply **Resource Tags**
...
- A **[Virtual Network](https://learn.microsoft.com/en-us/azure/virtual-network/virtual-networks-overview)** emulates a physical network
  ...
  - _Custom Routes:_
    - **[User-defined routes](https://learn.microsoft.com/en-us/azure/virtual-network/virtual-networks-udr-overview)** changes the way traffic is routed and override default System Routes
        - A UDR can be created _without_ a subnet, _however it will only be effective once the route is associated with the subnet_
...
+ **[Azure Migrate](https://learn.microsoft.com/en-us/azure/migrate/migrate-services-overview)** is a unified migration platform to start, run, and track your migration to Azure
